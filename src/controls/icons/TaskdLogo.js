        ...
        <div style={style} className="pb-logo">
            {isLink ? (
                ...
                <div style={{display: "flex"}}>
                    ...
                    {/* Editable Board Name */}
                    {boardName && (
                        // <div style={{display: "flex", marginTop: 8.5, marginLeft: 2, fontSize: 17.5, lineHeight: "22px", color: "#a0a0a0"}}>
                        <div style={{display: "flex", marginTop: 8.5, marginLeft: 2, fontSize: 17.5, lineHeight: "22px", color: "#9c9c9c"}}>
